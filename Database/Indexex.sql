...
CREATE INDEX idx_participation_emp_project ON participation (emp_id, project_id); -- в таблице participation
CREATE INDEX idx_employees_emp_id ON employees (emp_id, LAST_NAME); -- в таблице employees
CREATE INDEX idx_vacations_emp_id ON vacations (emp_id); -- в таблице vacations
